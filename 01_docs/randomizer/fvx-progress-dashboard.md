...
|---|---|
| Stand | Nach Gen Limit / Special Form / Mechanic Item Final Smoke 212 und UPR-FVX compat-Merge `8349daf5ce005f0defc5674cbc3a3468f009218c` bis PR #152, Type Effectiveness Battle Smoke 211, UPR-FVX PR #127 Fast-Egg-Hatching-Null-`BreedingInfo`-Guard, PR #126 Catching-Tutorial-Species-Mapping, PR #125 Running-Shoes-Misc-Tweaks, Misc Tweaks Behavior Smoke 210, PR #124 Expanded-Trainer-Logging-Fallback, PR #123 Gen3/CFRU-DPE Palette-Output-Writes, Graphics/Palettes Visual Smoke 209, PR #118 Wild Encounter Base-vs-Output Audit, Combined Trainer Visual Runtime Smoke 208, UPR-FVX PR #117 Rival-Counter-Starter/Intro-Species-0-Fix und combined visual smoke, PR #116 finalem Trainer Class Sprite Sync Smoke, PR #109 Intro-Mon Visual-Source-Fix-Smoke, PR #107/#108 Intro-Mon Visual-Source-Diagnose, PR #106 Pre/Post Runtime-Trainer-Audit, PR #105 Runtime-Source-Trainer-Randomization-Smoke, PR #104 Strict-Runtime-Trainer-Source-Sync, coverage-generated CLI profile matrix run und exact-coverage Batches 01 bis 18 CLI-Log-Smokes |
| UPR-FVX-Pin im Workspace | `8349daf5ce005f0defc5674cbc3a3468f009218c` |
...
| Zuletzt entblockt | Gen Limit / Special Form / Mechanic Item Final Smoke 212 bestaetigt `PASS_TARGETED_LOG_VISUAL_SMOKE_WITH_CAVEATS`: Gen-Limit 1-9 infrastructure works, Gen1-only und Gen1-6 log smokes looked correct, Gen7/8/9 Intro Mon no longer crashes and supports valid visual-table candidates, Mega/GMax/Regional/Irregular/Special-form filtering works in latest local checks, Evolutionary Relatives bleiben expliziter Cross-Gen-Family-Override, Regional forms werden nicht durch Evolutionary Relatives reingezogen unless Regional Forms across Gen Limit is enabled, Trainer Class Sprite Sync ist GUI-exposed, Oak-Lab Rival counter-starter bleibt unabhaengig von Rival Carries Starter Through Game erhalten, mechanic item filtering nutzt source-backed CFRU/DPE categories fuer Mega/Z/Dynamax-GMax items, Trainer Held Items / Sensible Items laufen ohne fruehere Missing-Pool-/Missing-Movepool-NPEs, und im letzten GUI-Smoke wurde kein aktueller Crash beobachtet; Type Effectiveness Battle Smoke 211 bestaetigt `PASS_TARGETED_BATTLE_SMOKE_WITH_CAVEATS`; Misc Tweaks Behavior Smoke 210 bestaetigt `PASS_TARGETED_BEHAVIOR_SMOKE_WITH_CAVEATS`; Graphics/Palettes Visual Smoke 209 bestaetigt targeted visual/audit pass; UPR-FVX PR #118 stellt den opt-in Wild Encounter Base-vs-Output Audit bereit; Combined Trainer Visual Runtime Smoke 208 bestaetigt `PASS_WITH_CAVEATS`; PR #117 fixt Rival-Counter-Starter/Intro-Species-0; PR #116 finalisiert `MODE-TRAINER-CLASS-SPRITE-SYNC`; PR #109 fixt die CFRU/DPE Gen9 BPRE Intro-Mon Visual-Source |
| Aktuelle Caveats | Gen Limit / Special Form / Mechanic Item Smoke 212 ist targeted local log/visual smoke, kein Full-Playthrough, keine vollstaendige Held-Item-Distribution-Audit und keine P1-Promotion; Plates/Drives/Memories/Nectars sind kategorisiert, haben aber noch keine separaten user-facing Policies; Static Script/Gift/NPC item sources bleiben caveated, falls sie nicht durch Randomizer-Item-Replacement-Pools laufen; custom/future form encodings ausserhalb dokumentierter CFRU/DPE identity blocks bleiben audit-required; Type Effectiveness 211 ist targeted battle smoke, keine vollstaendige Type-Matchup-Matrix; Misc Tweaks 210 ist targeted behavior smoke, kein Full-Hatch-Cycle-Proof und keine dedizierte Ban-Lucky-Egg-Proof-Evidence; Reusable TMs und Forgettable HMs sind CFRU-provided und sollen nicht doppelt durch das UPR-FVX stable profile aktiviert werden; Graphics/Palettes 209 ist targeted visual/audit smoke, keine breite species/form coverage und keine Shiny-Proof-Abdeckung (`shinyChangedCount=0`); Wild Encounter Base-vs-Output Audit ist diagnostic-only und deckt den modeled Gen3 base `WildPokemon` table path ab; CFRU/DPE special/runtime wild sources bleiben Follow-up, falls Audit und Ingame-Beobachtung auseinanderlaufen; Combined Trainer Visual Runtime Smoke 208 bleibt `PASS_WITH_CAVEATS`; Trainer Class Sprite Sync ist targeted visual-smoke-bestaetigt, aber kein Full-Playthrough oder globale Route-/Kategorie-Abdeckung; Runtime-source strict sync plus randomizer eligibility ist fuer Viridian Forest `531/532` lokal bestaetigt, aber keine breite Trainer/Foe-P1-Promotion; Special-Wild/Day-Night/Swarms bleiben separater Scope |
| Keine P1-Promotion | Aktuelle Updates sind Workspace-/Smoke-Status, keine neue P1-Freigabe |
| Naechster sinnvoller Block | Gen Limit / Special Form / Mechanic Item Exclusions nur bei Regression, voller Playthrough-Frage oder separatem Static Script/Gift/NPC Item-Source-Audit erneut vertiefen; Trainer Held Items / Sensible Items nur bei Regression oder fuer eine vollstaendige Held-Item-Distribution-Audit erneut vertiefen; Plates/Drives/Memories/Nectars brauchen separate Policy-Entscheidung, nicht automatische P1-Promotion; Type Effectiveness nur bei Regression oder fuer eine vollstaendige Type-Matchup-Matrix erneut vertiefen; Misc Tweaks nur bei Regression oder fuer Full-Hatch-/Ban-Lucky-Egg-/nicht beobachtete Detailpfade erneut vertiefen; wenn Graphics/Palettes weiter vertieft wird, shiny-fokussierte Palette-Audit-/Visual-Evidence und breitere Species/Form-Samples lokal und sanitisiert sammeln; wenn Wild-Log und Ingame-Wild auseinanderlaufen, lokalen privaten Base-vs-Output Wild Audit aus PR #118 nutzen und nur sanitized Summaries dokumentieren; CFRU/DPE special/runtime wild sources separat triagieren, falls modeled-table Audit und Ingame divergieren; Rival Carry nur bei breiterer all-starter-/later-appearance-Sampling-Frage erneut vertiefen; Trainer-Class-Sprite-Sync nur noch bei Regression oder breiterer Sampling-Frage weiter vertiefen; danach `loaded-mismatch`/`invalid` Runtime-Source-Rows separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen |
...
|---|---|---|---|---|---|---|
| General Options | Gen Limit / Special Form targeted smoke passed with caveats / Intro visual fix targeted-smoke passed / Species-0 regression fixed / no P1 promotion | `FVX-GEN-001`, `FVX-GEN-002` CLI log-smoked; Evidence 212 bestaetigt Gen-Limit 1-9 infrastructure, Gen1-only/Gen1-6 log-smoke correctness, Special-form filtering and mechanic item exclusion layer in targeted local checks; Intro random mode overlay log-smoked; PR #107/#108 dokumentieren Intro-Mon-Setting-Semantik und Visual-Source-Diagnose; PR #109 targeted smoke bestaetigt sichtbaren Oak-Intro-Sprite-Wechsel weg von Nidoran female; PR #117 targeted smoke bestaetigt sichtbaren Blissey Intro Mon und keine Species-0-Regression; 208 Combined Trainer Visual Runtime Smoke bestaetigt sichtbar randomisierten Intro Mon; Evidence 212 bestaetigt Gen7/8/9 Intro Mon crash-free valid visual-table candidates | - | Race Mode bleibt offen; Evidence 212 ist targeted log/visual smoke, kein Full-Playthrough und keine P1-Promotion; custom/future form encodings ausserhalb dokumentierter CFRU/DPE identity blocks bleiben audit-required | weitere Gen-Limit/Special-Form/Intro-Mon-Evidence nur bei Regression/Full-Playthrough; General-/Race-Smoke spaeter | 064, 197, 198, 201, 205, 207, 208, 212, PR109, PR117, PR150 |
...
| Foe Pokemon / Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Rival Carry targeted-smoke passed / Trainer Class Sprite Sync targeted-smoke passed and GUI-exposed / Trainer Held Items targeted smoke passed with caveats / Combined trainer visual runtime smoke passed with caveats | Trainer Pokemon core, Trainer Movesets, Trainer Names; `FVX-FOE-001` bis `014` and exact Foe mode overlays CLI log-smoked; Rival Carries Starter Through Game targeted-smoke-confirmed for Player Charmander -> Oak-Lab Rival Squirtle and Route-22 Rival Squirtle after Foe Pokemon randomization; Evidence 212 bestaetigt Oak-Lab Rival counter-starter is preserved independently of Rival Carries Starter Through Game; 208 bestaetigt Route-22-Rival-Sprite consistency; Route-22 Rival non-starter Pokemon Silvally Lv9 demonstrates that non-starter Rival Pokemon remain eligible for Foe Pokemon randomization; `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted-smoke-confirmed for class label/classId/pic consistency and Evidence 212 notes it is GUI-exposed; Evidence 212 reports Trainer Held Items / Sensible Items run without the earlier missing-pool or missing-movepool NPEs; Viridian Forest trainer sprites randomized in 208; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Battle Style, Full-Rival-Carry, Trainer Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked or documented | Rival Carry targeted smoke covers one sampled starter path, not all starter choices or full playthrough; Runtime-source `531/532` Trainer Pokemon path is locally smoke-confirmed, but broader loaded-mismatch/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync is targeted visual-smoke-confirmed only and should be enabled when Trainer Class Names are randomized; Trainer Held Items / Sensible Items evidence is targeted NPE-free GUI smoke, not full distribution proof | `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Held-Item-Distribution nur bei Regression oder separatem Audit erneut vertiefen; Graphics/Palettes und Misc Tweaks isolieren; Rival Carry und Trainer-Class-Sprite-Sync nur bei Regression/breiterem Sampling erneut vertiefen | 190, 191, 197, 198, 199, 201, 202, 203, 204, 206, 207, 208, 212, PR116, PR117, PR151, PR152 |
| Wild Pokemon | Working-matrix passed / exact coverage passed with Special-Wild caveat / output audit available | Standard/Fallback Wild, normale Encounter-Smokes; `FVX-WILD-001` bis `012` and exact Wild location overlays CLI log-smoked; PR #118 Wild Encounter Base-vs-Output Audit diagnostic-only verfuegbar fuer modeled Gen3 base `WildPokemon` table path | Similar Strength, Type Restrictions, Catch Rate, Catch Em All, Level Modifier and exact Wild location modes log-smoked | Special-Wild/Day-Night/Swarms bleiben separater Scope trotz clean CLI profile; CFRU/DPE special/runtime wild sources bleiben Follow-up, falls Audit und Ingame divergieren | bei Wild-Log/Ingame-Divergenz privaten Audit nutzen, danach ggf. Special-/Runtime-Wild-Quellen separat triagieren | 190, 191, 197, 198, 201, PR118 |
...
| Items | Working-matrix passed mit Caveats / generated CLI profile passed / exact Batch 02 passed / mechanic item filtering targeted-smoke passed with caveats | Field Items basic, Pickup Items, Shop Items; Evidence 212 bestaetigt source-backed CFRU/DPE categories fuer Mega/Z/Dynamax-GMax mechanic item filtering | Item single/variant profiles in Batch 02 log-smoke | Required-TM-Field-Item-Zwang kann bei expanded TMs blockieren; supported/special shops bestaetigt; Plates/Drives/Memories/Nectars kategorisiert aber ohne separate user-facing Policies; Static Script/Gift/NPC item sources bleiben caveated wenn sie nicht durch replacement pools laufen | local boot/play or item-specific ingame smoke; Static Script/Gift/NPC source audit nur bei neuem Leak | 190, 191, 197, 198, 200, 212 |
| Types | PASS_TARGETED_BATTLE_SMOKE_WITH_CAVEATS | `FVX-TYPE-001` bis `003` and exact Random/Random-Balanced/Keep-Identities/Inverse overlays CLI log-smoked; 211 bestaetigt targeted Battle-Smoke ohne Battle-Crash | - | keine vollstaendige Type-Matchup-Matrix, kein Full-Playthrough und keine P1-Promotion | Regression oder vollstaendige Type-Matchup-Matrix nur separat | 190, 197, 198, 201, 211 |
...
| Misc Tweaks | PASS_TARGETED_BEHAVIOR_SMOKE_WITH_CAVEATS | `FVX-MISC-001` bis `012` log-smoked ohne Bad Marker; Evidence 210 bestaetigt targeted behavior smoke fuer Fastest Text, PC Potion, Running Shoes, Catching Tutorial und Fast Egg crash-free randomization/output-load | - | Ban Lucky Egg nur likely pass / no issue observed; Fast Egg ohne full hatch-cycle proof; Reusable TMs/Forgettable HMs CFRU-provided und nicht im UPR-FVX stable profile duplizieren; kein Full-Playthrough und keine P1-Promotion | nur bei Regression oder fuer Full-Hatch-/Ban-Lucky-Egg-/Detailpfade separat nachtesten | 197, 198, 201, 210, PR125, PR126, PR127 |

## GUI-Feature-Gruppen

| GUI-Gruppe | Hauptstatus | Was funktioniert? | Was ist nur Carrier-tested? | Offen / blockiert | Naechster Schritt |
|---|---|---|---|---|---|
| General Options | Gen Limit / Special Form targeted smoke passed with caveats; exact coverage passed fuer `FVX-GEN-001/002`; Intro visual fix targeted-smoke passed | Limit Pokemon, No Premature Evolutions and Intro random mode CLI log-smoked; Evidence 212 bestaetigt Gen-Limit 1-9 infrastructure, Gen1-only/Gen1-6 log smokes and Gen7/8/9 Intro Mon valid visual-table candidates; `No Random Intro Mon` negative GUI-Option und `randomizeIntroMon=true` aktiver Pfad dokumentiert; sichtbarer Oak-Intro-Sprite wechselte nach PR #109 weg von Nidoran female; 208 Combined Trainer Visual Runtime Smoke bestaetigt sichtbar randomisierten Intro Mon | - | Race Mode bleibt offen; Intro-Fix und Gen-Limit/Special-Form-Smoke sind targeted Smoke, kein Full-Playthrough und keine P1-Promotion; custom/future form encodings ausserhalb dokumentierter CFRU/DPE identity blocks bleiben audit-required | weitere Intro Mon oder Gen-Limit/Special-Form Evidence nur bei Regression/Full-Playthrough; General-/Race-Smoke spaeter |
...
| Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Trainer Class Sprite Sync targeted-smoke passed and GUI-exposed / Trainer Held Items targeted smoke passed with caveats / Combined trainer visual runtime smoke passed with caveats | Species, Movesets, Trainer Names; `MODE-TRAINER-CLASS-SPRITE-SYNC` fuer class label/classId/pic consistency targeted-smoke-confirmed and now GUI-exposed per Evidence 212; 208 bestaetigt Viridian-Forest-Trainer-Sprites randomisiert, Route-22-Rival-Sprite konsistent mit Oak-Lab-Rival-Sprite und Route-22 Rival starter Squirtle; Evidence 212 bestaetigt Oak-Lab Rival counter-starter is preserved independently of Rival Carries Starter Through Game; Evidence 212 reports Trainer Held Items / Sensible Items run without the earlier missing-pool or missing-movepool NPEs; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Special Rules, Battle Style, Full-Rival-Carry, Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked/documented | Broader `loaded-mismatch`/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync targeted smoke is not full-playthrough proof and should be enabled when Trainer Class Names are randomized; Silvally Lv9 on Route 22 is documented as randomized non-starter Rival Pokemon, not as starter-carry failure; Trainer Held Items / Sensible Items evidence is targeted NPE-free GUI smoke, not full distribution proof | `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Held-Item-Distribution nur bei Regression oder separatem Audit erneut vertiefen; Trainer-Class-Sprite-Sync nur bei Regression/breiterem Sampling erneut vertiefen |
| Wild | Working-matrix passed / generated matrix passed / output audit available | Standard/Fallback Wild; PR #118 Base-vs-Output Audit diagnostic-only fuer modeled Gen3 base `WildPokemon` table path | Similar Strength, Type Restrictions, Catch Rate, Catch Em All, Level Modifier and exact Wild location modes log-smoked | Special-Wild/Day-Night/Swarms separater Scope trotz clean CLI profile; CFRU/DPE special/runtime wild sources Follow-up bei Audit/Ingame-Divergenz | privaten Audit bei Wild-Log/Ingame-Divergenz nutzen; separater Special-/Runtime-Wild-Scope falls freigegeben |
...
| Items | Working-matrix passed mit Caveats / mechanic item filtering targeted-smoke passed with caveats | Field Items basic, Pickup Items, Shop Items; source-backed CFRU/DPE Mega/Z/Dynamax-GMax mechanic item filtering from Evidence 212 | - | Field Items Required-TM-Zwang; supported/special shops bestaetigt; Plates/Drives/Memories/Nectars kategorisiert ohne separate Policy; Static Script/Gift/NPC item sources caveated falls ausserhalb replacement pools | Basic Field Items verwenden; mechanic-item leaks nur mit source-specific sanitized evidence triagieren |
| TypeEffectiveness | PASS_TARGETED_BATTLE_SMOKE_WITH_CAVEATS | Random/Random-Balanced/Keep-Identities/Inverse/Update/Add Immunities CLI log-smoked; targeted battle smoke passed ohne Battle-Crash | - | keine vollstaendige Type-Matchup-Matrix, kein Full-Playthrough und keine P1-Promotion | Regression oder Type-Matchup-Matrix nur separat |
...
| Misc Tweaks | PASS_TARGETED_BEHAVIOR_SMOKE_WITH_CAVEATS | 12 Tweaks log-smoked; Evidence 210 targeted behavior smoke for key Misc paths | - | Fast Egg nur crash-free/output-load; Ban Lucky Egg likely pass; Reusable TMs/Forgettable HMs CFRU-provided; kein P1 | Detailpfade nur bei Regression oder gezieltem Nachtest |
...
|---:|---|---|---|---|---|
| 1 | `FVX-GEN-001` | General Options | Limit Pokemon | Gen-Limit 1-9 targeted log/visual smoke passed with caveats | Evidence 212; no full playthrough or P1 promotion |
| 2 | `FVX-GEN-002` | General Options | No Premature Evolutions | Exact coverage CLI passed | Log-smoke / Ingame follow-up needed |
| 3 | `FVX-GEN-003` | General Options | No Random Intro Mon | Intro visual fix targeted-smoke passed; Gen7/8/9 Intro Mon crash fixed; no P1 promotion | Negative GUI option; `MODE-NO-RANDOM-INTRO` / `FVX-GEN-003` set `randomizeIntroMon=false`; PR #109 fixes confirmed CFRU/DPE visual source; 208 confirms visibly randomized Intro Mon; 212 confirms Gen7/8/9 valid visual-table candidates; full-playthrough still open |
...
| 66 | `FVX-FOE-008` | Foe Pokemon | Trainer Held Items | Targeted NPE-free GUI smoke passed with caveats | Evidence 212; no full held-item distribution proof or P1 |
...
| 70 | `FVX-FOE-012` | Foe Pokemon | Rival Carries Starter Through Game | Targeted visual smoke passed with caveat | Oak-Lab counter-starter preserved independently of Rival Carries; Player Charmander -> Oak-Lab Rival Squirtle and Route-22 Rival Squirtle; Silvally Lv9 was a randomized non-starter Rival Pokemon; no P1 promotion |
| 71 | `FVX-FOE-013` | Foe Pokemon | Randomize Trainer Names / Class Names | Trainer Names passed; Class Names textlabel-only without Sync; Sprite Sync targeted-smoke passed and GUI-exposed | `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted visual smoke and GUI control; enable when Trainer Class Names are randomized; regular per-trainer assignments; Rival/Friend grouped consistency; no P1 promotion |
...
| 73 | `FVX-WILD-001` | Wild Pokemon | Randomize Wild Pokemon | Stable-profile passed; output audit available | Standard/Fallback Wild; PR #118 diagnostic-only Base-vs-Output Audit for modeled Gen3 base `WildPokemon` table path |
...
| 110 | `FVX-TYPE-001` | Types | Type Effectiveness Random/Balanced/Keep Identities/Inverse | Targeted battle smoke passed with caveats | Evidence 211 local battle smoke; no full type-chart matrix or P1 |
| 111 | `FVX-TYPE-002` | Types | Add Random Immunities | Targeted battle smoke passed with caveats | Evidence 211 TypeEffectiveness smoke; no suboption-specific full matrix or P1 |
| 112 | `FVX-TYPE-003` | Types | Update Type Effectiveness | Targeted battle smoke passed with caveats | Evidence 211 TypeEffectiveness smoke; no full type-chart matrix or P1 |
| 113 | `FVX-GFX-001` | Graphics | Pokemon Palettes Random | Targeted visual/audit smoke passed with caveats | No P1; broaden species/form samples later |
| 114 | `FVX-GFX-002` | Graphics | Palettes: Follow Types | Targeted visual/audit smoke passed with caveats | No P1; type-follow behavior not separately de-caveated |
| 115 | `FVX-GFX-003` | Graphics | Palettes: Follow Evolutions | Targeted visual/audit smoke passed with caveats | No P1; evolution-follow behavior not separately de-caveated |
...
| 119 | `FVX-MISC-001` | Misc Tweaks | Fastest Text | Targeted behavior smoke passed with caveats | Evidence 210 local pass; no P1 |
| 120 | `FVX-MISC-002` | Misc Tweaks | Running Shoes Indoors | Targeted behavior smoke passed with caveats | Evidence 210 local pass after PR #125; no P1 |
| 121 | `FVX-MISC-003` | Misc Tweaks | Randomize PC Potion | Targeted behavior smoke passed with caveats | Evidence 210 local pass; no P1 |
| 122 | `FVX-MISC-004` | Misc Tweaks | Give National Dex at Start | Targeted Misc status with caveat | Not separately strengthened beyond Misc targeted smoke; no P1 |
| 123 | `FVX-MISC-005` | Misc Tweaks | Fast Egg Hatching | Crash-free randomization smoke with caveats | Evidence 210 output-load after PR #127; no full hatch-cycle proof |
| 124 | `FVX-MISC-006` | Misc Tweaks | Lower Case Pokemon Names | Targeted Misc status with caveat | Not separately strengthened beyond Misc targeted smoke; no P1 |
| 125 | `FVX-MISC-007` | Misc Tweaks | Randomize Catching Tutorial | Targeted behavior smoke passed with caveats | Evidence 210 local pass after PR #126; no question-mark sprite/name |
| 126 | `FVX-MISC-008` | Misc Tweaks | Ban Lucky Egg | Likely pass with caveat | No issue observed; no dedicated drop/item proof |
| 127 | `FVX-MISC-009` | Misc Tweaks | Balance Static Pokemon Levels | Targeted Misc status with caveat | Not separately behavior-proven in Evidence 210; no P1 |
| 128 | `FVX-MISC-010` | Misc Tweaks | Run Without Running Shoes | Targeted behavior smoke passed with caveats | Evidence 210 local pass after PR #125; no P1 |
| 129 | `FVX-MISC-011` | Misc Tweaks | Reusable TMs | CFRU-provided stable-profile caveat | Do not duplicate through UPR-FVX stable profile |
| 130 | `FVX-MISC-012` | Misc Tweaks | Forgettable HMs | CFRU-provided stable-profile caveat | Do not duplicate through UPR-FVX stable profile |
...
| P1 | Rival Carries Starter Through Game | targeted visual smoke passed with caveat | `FVX-FOE-012` | Player Charmander -> Oak-Lab Rival Squirtle und Route-22 Rival Squirtle lokal bestaetigt; Evidence 212 bestaetigt Oak-Lab Rival counter-starter preserved independently of Rival Carries Starter Through Game; Silvally Lv9 war ein randomisiertes Non-Starter-Rival-Pokemon; kein Full-Playthrough und keine all-starter-choice matrix | breiteres Sampling nur bei Bedarf; keine P1-Promotion | 179, 192, 201, 207, 208, 212, PR117 |
...
| P1 | Trainer Names/Class Names / Sprite Sync | Trainer Names passed; Class Names textlabel-only without Sync; Sprite Sync targeted-smoke passed and GUI-exposed | `FVX-FOE-013` | `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted visual-smoke-confirmed; Evidence 212 bestaetigt GUI exposure and recommends enabling Sync when Trainer Class Names are randomized; 208 bestaetigt Route-22 Rival sprite consistency und Viridian Forest trainer sprites randomized; aber kein Full-Playthrough und keine P1-Promotion; ohne Sync bleibt legacy/textlabel-only | nur bei Regression oder breiterem Sampling erneut vertiefen; keine P1-Promotion | 190, 206, 208, 212, PR116 |
...
| P1 | Palette Randomization | targeted visual/audit smoke passed with caveats; no P1 promotion | `FVX-GFX-001` bis `FVX-GFX-004` | 209 bestaetigt sampled normal palette changes and visible palette changes; Shiny bleibt caveated (`shinyChangedCount=0`), kein Full-Playthrough und keine breite Species/Form-Abdeckung | Shiny-fokussierte Palette-Audit-/Visual-Evidence und breitere Species/Form-Samples nur lokal und sanitisiert sammeln | 058, 197, 201, 209 |
...
| P2 | Misc Tweaks | PASS_TARGETED_BEHAVIOR_SMOKE_WITH_CAVEATS | `FVX-MISC-001` bis `FVX-MISC-012` | Evidence 210 bestaetigt targeted Behavior-Smoke mit Caveats; Fast Egg ohne full hatch-cycle proof, Ban Lucky Egg likely pass, Reusable TMs/Forgettable HMs CFRU-provided | nur bei Regression oder fuer Detailpfade separat nachtesten | 197, 201, 210, PR125, PR126, PR127 |

## Naechste empfohlene Arbeitspakete

| Reihenfolge | Arbeitspaket | Ziel | Warum jetzt? | Erwartetes Ergebnis |
|---:|---|---|---|---|
| 1 | Gen Limit / Special Form / Mechanic Item Regression Only | nur bei neuem Leak oder voller Playthrough-Frage weiter vertiefen | Evidence 212 ist targeted passed with caveats; kein aktueller Pokemon-Special-Form-Leak beobachtet | keine P1-Promotion; Static Script/Gift/NPC Item-Source-Audit nur bei neuem sanitized Befund |
| 2 | Trainer Runtime Source Evidence | zweite Rival-, Brock- und normale Trainer-Battles gegen `TrainerData`-Runtime-Quelle vergleichen | Foe Trainer ist CLI-log-clean, aber ingame partial/caveated | lokale opt-in Diagnose, nur redaktierte Evidence |
| 3 | Stable Visual Profile + Starter Pokemon + Intro Mon | groesstes aktuelles Normalprofil laenger samplen | Stable Visual Profile passed, Oak-Lab Rival Sync passed, PR #117 combined visual smoke passed, 208 combined trainer visual runtime smoke `PASS_WITH_CAVEATS`, Evidence 212 Gen7/8/9 Intro Mon visual candidates passed and Intro Mon visual fix targeted-smoke passed | lokaler Smoke nur bei Bedarf mit Starters ON, Intro Mon ON, Trainer Class Names nach Scope, Special-Wild OFF |
| 4 | Rival Carries Starter Through Game | weitere Starter-/Rival-Auftritte samplen | ein Counter-Pfad ist fuer Oak-Lab und Route 22 targeted-smoke-bestaetigt; Evidence 212 bestaetigt Oak-Lab counter-starter independent von Rival Carries; keine all-starter-choice matrix und kein Full-Playthrough | breiteres lokales Sampling nur bei Bedarf |
| 5 | Evolution Randomization | aktive Evolution-Randomization separat pruefen | Evolutions unchanged preserved, Randomization selbst OFF im Stable-Profil | separater Evolution-Smoke |
| 6 | Trainer Class Sprite Sync Sampling | nur bei Regression oder breiterer Kategoriefrage erneut pruefen | `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted-smoke-confirmed and GUI-exposed; ohne Sync bleibt Class Names textlabel-only | kein aktueller Fixbedarf; keine P1-Promotion |
| 7 | Field Items Required-TM Overflow | expanded-TM-Zwang absichern oder vermeiden | Basic Field Items passed, Required-TM-Zwang kann blockieren; mechanic item categories targeted-smoke passed in Evidence 212 | Option separat diagnostizieren |
| 8 | Evolution Methods / Make Easier 025B | Methoden-/Byte-Patch-Slices getrennt halten | Non-ROM-Evidenz fuer Teile, Writer-/Reload-Evidenz fehlt | nur explizit freigegebener Scope |
| 9 | Palette Randomization | Shiny-/Breitensampling nachziehen | targeted visual/audit smoke 209 passed with caveats: sampled normal palettes changed and visual changes observed; shiny sample unchanged | `FVX-GFX-001` bis `FVX-GFX-004` bleiben ohne P1, Shiny gesondert absichern |
| 10 | Special-Wild / Special Tutors/Text/Menu | Sonderpfade modellieren | Special-Wild CLI profile clean, aber Scope bleibt separat | P2- oder separater Diagnose-Scope |
| 11 | Graphics/Sprites / Misc Detailpfade | Custom Graphics modellieren; Misc nur bei Regression oder Detailfragen nachtesten | Palettes targeted smoke passed with caveats; Misc targeted behavior smoke passed with caveats | P2-Entscheidung fuer Custom Graphics; Misc Detailpfade nur separat |

## Zuletzt abgeschlossene PRs / Diagnosen

| Diagnose / PR | Bereich | Ergebnis | Statuswirkung |
|---|---|---|---|
| 212 Gen Limit / Special Form / Mechanic Item Final Smoke | Gen-Limit / Special Forms / Items / Trainer Held Items | UPR-FVX compat pin `8349daf5ce005f0defc5674cbc3a3468f009218c`; Gen-Limit 1-9 infrastructure works; Gen1-only and Gen1-6 log smokes looked correct; Gen7/8/9 Intro Mon no longer crashes; Special-form filtering works in latest checks; Trainer Class Sprite Sync GUI-exposed; Oak-Lab Rival counter-starter preserved; mechanic item filtering uses source-backed CFRU/DPE categories; Trainer Held Items / Sensible Items run without earlier NPEs | `PASS_TARGETED_LOG_VISUAL_SMOKE_WITH_CAVEATS`; no full playthrough, no full held-item distribution audit, no P1 promotion; Plates/Drives/Memories/Nectars policy, Static Script/Gift/NPC item sources and custom/future form encodings remain caveated |
| Workspace sync / UPR-FVX PR #118 | Wild Encounter Output Audit | UPR-FVX Pin `ed692d07bfc81405706f2b94fda06639426e6a75`; opt-in Base-vs-Output Audit vergleicht modeled Gen3 base `WildPokemon` table slots mit per-slot changed marker und Summary | Diagnostic-only; keine Writer-/Randomizer-Verhaltensaenderung; CFRU/DPE special/runtime wild sources bleiben Follow-up bei Audit/Ingame-Divergenz; keine P1-Promotion |
| 208 Combined Trainer Visual Runtime Smoke | Combined Trainer Visual Runtime | Intro Mon sichtbar randomisiert; Player starter Charmander; Oak-Lab Rival starter Squirtle; Route-22 Rival starter Squirtle; Route-22-Rival-Sprite konsistent mit Oak-Lab-Rival-Sprite; Viridian-Forest-Trainer-Sprites randomisiert; keine crashes/freezes/garbled sprites beobachtet | `PASS_WITH_CAVEATS`; Silvally Lv9 war ein randomisiertes Non-Starter-Rival-Pokemon, waehrend der Rival-Starter-Slot korrekt Squirtle blieb; keine P1-Promotion |
| Workspace sync / UPR-FVX PR #117 | Rival Counter Starter / Combined Visual Smoke | UPR-FVX Pin `5983011752273e00c402e25cc1ae1a9baca110f1`; Rival starter is corrected after Foe Pokemon randomization and Intro Mon Species `0` is rejected for extended CFRU/DPE BPRE pools | Combined visual Rival test fixed; visible Blissey Intro Mon; Player Charmander -> Rival Squirtle; prior Trainer Class Sprite Sync visual checks remain okay; no crash/freeze/garbled sprite observed; no P1-Promotion |
| Workspace sync / UPR-FVX PR #109 | Intro Mon Visual Source Fix | UPR-FVX Pin `a9bb4a5f201c5078ec02fe1f2f8417695448afe9`; CFRU/DPE Gen9 BPRE syncs confirmed Nidoran-female front-image and normal-palette table entries to the selected intro species asset pointers | `FVX-GEN-003` visual mismatch locally fixed in targeted smoke; no crash/freeze/garbled sprite observed; no P1-Promotion |
| Workspace sync / UPR-FVX PR #107 | Intro Mon Visual Source Diagnostics | UPR-FVX Pin `a7e098a5158d824b1ddec62a286f2a6ffafce8e4`; opt-in known FRLG Intro-Mon literal/pointer report plus optional Base-vs-Output comparison available | Intro-Mon setting semantics documented; diagnosis-only, no visible Intro-Mon fix and no P1-Promotion |

...
|---|---|
| Stand | Nach Workspace PR #272 / UPR-FVX PR #98 und coverage-generated CLI profile matrix run |
...
| CLI Profile Matrix | Coverage-generated `.rnqs` profile matrix log-smoke passed for 14 profiles; bad markers 0 and warnings 0 for all profiles |
...
| Zuletzt entblockt | Coverage manifest generated settings and CLI matrix log-smoke path passed; previous expected-fail profiles remain caveated unexpected passes |

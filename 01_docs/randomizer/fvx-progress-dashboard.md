...
|---|---|
| Stand | Nach UPR-FVX PR #100 Trainer-Runtime-Source-Diagnose-Sync, coverage-generated CLI profile matrix run und exact-coverage Batches 01 bis 18 CLI-Log-Smokes |
| UPR-FVX-Pin im Workspace | `87bba797620dd2043f02c11c67f7b752a7238a00` |
...
| Zuletzt entblockt | UPR-FVX PR #100 stellt ein No-ROM/opt-in Trainer-Runtime-Source-Diagnose-Harness bereit; exact-coverage Batches 03-18 filled generator-capable CLI log-smoke coverage across TM/Tutor, Wild, Foe, General/Traits, Starters/Statics/Trades, Moves, Graphics/Palettes, Misc, Types, cumulative profiles and exact Foe/Wild/Type/Intro mode overlays |
| Aktuelle Caveats | Foe Trainer ist CLI-log-clean, aber ingame partial/caveated bis Runtime-Source-Evidence fuer betroffene Battles vorliegt; Trainer Class Names bleibt textlabel-only; Graphics/Palettes und Misc Tweaks brauchen Visual-/Behavior-Smokes; Intro Mon braucht visuelle Bestaetigung; Gen-Limit-1-9 `MODE-*` Overlays bleiben unsupported by Settings format; Special-Wild/Day-Night/Swarms bleiben separater Scope; `Rival Carries Starter Through Game` hat CLI-Log-Smoke, aber keinen Ingame-/Full-Rival-Smoke |
| Keine P1-Promotion | Aktuelle Updates sind Workspace-/Smoke-Status, keine neue P1-Freigabe |
| Naechster sinnvoller Block | Lokale opt-in Trainer-Runtime-Source-Evidence fuer zweiten Rival, Brock und ausgewaehlte normale Trainer sammeln; danach gezielt Ingame-/Visual-/Behavior-Smokes isolieren: Trainer Held Items Sensible, Graphics/Palettes, Misc Tweaks, Special-Wild und Full-Rival-Carry |
...
| Foe Pokemon / Trainer | Working-matrix passed mit Caveat / exact coverage passed / runtime-source diagnosis ready | Trainer Pokemon core, Trainer Movesets, Trainer Names; `FVX-FOE-001` bis `014` and exact Foe mode overlays CLI log-smoked | Additional Pokemon, Type Diversity / Type Themes, Battle Style, Full-Rival-Carry, Trainer Held Items and exact Foe modes log-smoked | Ingame partial/caveated: zweiter Rival, Brock und einzelne normale Trainer koennen eine andere Runtime-Source nutzen als der Trainer-Log; Trainer Class Names textlabel-only; Sprite/Class-ID mismatch erwartbar; Sensible Held Items braucht fokussierte Isolation; Full-Rival-Carry braucht Ingame-Smoke | Lokale redaktierte Runtime-Source-Diagnose fuer betroffene Battles; dann Trainer Class Names OFF lassen oder Class Assignment separat planen; Sensible Items und Full-Rival-Carry isolieren | 190, 191, 197, 198, 199, 201, 202 |
...
| Trainer | Working-matrix passed mit Caveat / exact coverage passed / runtime-source diagnosis ready | Species, Movesets, Trainer Names | Additional Pokemon, Type Diversity / Type Themes, Special Rules, Battle Style, Full-Rival-Carry, Held Items and exact Foe modes log-smoked | Ingame partial/caveated bis Runtime-Source-Evidence fuer betroffene Battles vorliegt; Trainer Class Names textlabel-only; Sensible Held Items und Full-Rival-Carry brauchen fokussierte Ingame-Smokes | Redaktierte Runtime-Source-Diagnose fuer zweiten Rival, Brock und ausgewaehlte normale Trainer; Trainer Class Names fuer Stable-Visual OFF lassen; Sensible Items und Full-Rival-Carry isolieren |

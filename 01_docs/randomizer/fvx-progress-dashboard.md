...
|---|---|
| Stand | Nach UPR-FVX PR #111 Trainer Class Sprite Sync, PR #109 Intro-Mon Visual-Source-Fix-Smoke, PR #107/#108 Intro-Mon Visual-Source-Diagnose, PR #106 Pre/Post Runtime-Trainer-Audit, PR #105 Runtime-Source-Trainer-Randomization-Smoke, PR #104 Strict-Runtime-Trainer-Source-Sync, coverage-generated CLI profile matrix run und exact-coverage Batches 01 bis 18 CLI-Log-Smokes |
| UPR-FVX-Pin im Workspace | `4805a5a930bc97203199816222465c76de2f2150` |
...
| Zuletzt entblockt | UPR-FVX PR #111 stellt `MODE-TRAINER-CLASS-SPRITE-SYNC` bereit: `Randomize Trainer Names` bleibt personal-name-only; `Randomize Trainer Class Names` bleibt ohne Sync legacy/textlabel-only; mit Sync folgen `trainerClass` und sichtbarer `trainerPic` der Trainer-Class-Name-Zuordnung fuer class label/classId/pic consistency; PR #109 fixt die CFRU/DPE Gen9 BPRE Intro-Mon Visual-Source fuer den bestaetigten Nidoran-female Asset-Table-Scope; sanitized local smoke bestaetigt, dass der sichtbare Oak-Intro-Sprite weg von Nidoran female wechselte und kein Crash/Freeze/garbled sprite beobachtet wurde; PR #106 stellt das Post-Audit-Tooling bereit; PR #105 macht generische `RUNTIME-SOURCE` Trainer randomizer-eligible; sanitized local evidence bestaetigt Viridian Forest `531/532` mit randomized loaded/raw parties, Ingame-Smoke Eiscue und randomized-output Audit `unloaded-valid-parties total=0` |
| Aktuelle Caveats | Trainer Class Sprite Sync braucht finalen lokalen Smoke auf dem gemergten PR-#111-Pin; bisherige sanitized Evidence bestaetigt nur pre-final-merge, dass ein Regular trainer battle started, visible sprite changed und class/sprite sync markers im Log standen; Intro-Mon Visual-Mismatch ist targeted ingame-smoke-bestaetigt gefixt, aber kein Full-Playthrough und keine P1-Promotion; Runtime-source strict sync plus randomizer eligibility ist fuer Viridian Forest `531/532` lokal bestaetigt, aber keine breite Trainer/Foe-P1-Promotion; `loaded-mismatch`, invalid-pointer, empty-party und out-of-range rows sowie Full-Playthrough bleiben Diagnose-/Follow-up-Scope; Graphics/Palettes und Misc Tweaks brauchen Visual-/Behavior-Smokes; Gen-Limit-1-9 `MODE-*` Overlays bleiben unsupported by Settings format; Special-Wild/Day-Night/Swarms bleiben separater Scope; `Rival Carries Starter Through Game` hat CLI-Log-Smoke, aber keinen Ingame-/Full-Rival-Smoke |
| Keine P1-Promotion | Aktuelle Updates sind Workspace-/Smoke-Status, keine neue P1-Freigabe |
| Naechster sinnvoller Block | Finalen lokalen Trainer-Class-Sprite-Sync-Smoke auf Pin `4805a5a930bc97203199816222465c76de2f2150` ausfuehren; danach `loaded-mismatch`/`invalid` Runtime-Source-Rows separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; gezielt Ingame-/Visual-/Behavior-Smokes isolieren: Trainer Held Items Sensible, Graphics/Palettes, Misc Tweaks, Special-Wild und Full-Rival-Carry |
...
| Foe Pokemon / Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Trainer Class Sprite Sync opt-in available | Trainer Pokemon core, Trainer Movesets, Trainer Names; `FVX-FOE-001` bis `014` and exact Foe mode overlays CLI log-smoked; `MODE-TRAINER-CLASS-SPRITE-SYNC` available for class label/classId/pic consistency; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Battle Style, Full-Rival-Carry, Trainer Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked or documented | Runtime-source `531/532` Trainer Pokemon path is locally smoke-confirmed, but broader loaded-mismatch/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync still needs final local smoke on merged pin; without Sync Trainer Class Names remains legacy/textlabel-only; Sensible Held Items braucht fokussierte Isolation; Full-Rival-Carry braucht Ingame-Smoke | finalen Trainer-Class-Sprite-Sync-Smoke auf PR-#111-Pin ausfuehren; `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Sensible Items und Full-Rival-Carry isolieren | 190, 191, 197, 198, 199, 201, 202, 203, 204, 206, PR111 |
...
| Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Trainer Class Sprite Sync opt-in available | Species, Movesets, Trainer Names; `MODE-TRAINER-CLASS-SPRITE-SYNC` fuer class label/classId/pic consistency; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Special Rules, Battle Style, Full-Rival-Carry, Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked/documented | Broader `loaded-mismatch`/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync still needs final local smoke on merged pin; without Sync Trainer Class Names remains legacy/textlabel-only; Sensible Held Items und Full-Rival-Carry brauchen fokussierte Ingame-Smokes | finalen Trainer-Class-Sprite-Sync-Smoke auf PR-#111-Pin ausfuehren; `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Sensible Items und Full-Rival-Carry isolieren |
...
| 71 | `FVX-FOE-013` | Foe Pokemon | Randomize Trainer Names / Class Names | Trainer Names passed; Class Names textlabel-only without Sync; Sprite Sync opt-in available | `MODE-TRAINER-CLASS-SPRITE-SYNC` follows class mapping; final merged-pin smoke needed |
...
| P1 | Trainer Names/Class Names / Sprite Sync | Trainer Names passed; Class Names textlabel-only without Sync; Sprite Sync opt-in available | `FVX-FOE-013` | Finaler merged-pin Smoke fuer `MODE-TRAINER-CLASS-SPRITE-SYNC` fehlt; ohne Sync bleibt legacy/textlabel-only | finalen lokalen Sprite-Sync-Smoke auf PR-#111-Pin ausfuehren; keine P1-Promotion | 190, 206, PR111 |

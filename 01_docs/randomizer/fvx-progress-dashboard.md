...
| Graphics | exact coverage passed mit Caveat / P2 gemischt / isolated smoke input prepared | `FVX-GFX-001` bis `004` Palette Randomization log-smoked ohne Bad Marker; lokales ignoriertes Manual-Profil `graphics_palettes_smoke.rnqs` aus `risk_graphics_palettes_visual` vorbereitet | - | Ingame visual smoke fuer Palettes fehlt; Custom Player Graphics bleibt manual/out-of-scope; kein Evidence-Update und keine P1-Promotion | isolierten Palette-Visual-Smoke nur mit `FVX-GFX-001` bis `004` lokal ausfuehren; Wild/Foe/Items/Misc/Type-Chaos ausgeschlossen halten | 058, 191, 197, 198, 201 |
...
| Palettes | exact coverage passed mit Caveat / isolated smoke input prepared | Palette Randomization log-smoked; lokales Manual-Profil fuer `FVX-GFX-001` bis `004` vorbereitet | - | Ingame visual smoke fehlt; keine Evidence-Aktualisierung ohne lokalen Smoke | isolierter Palette Visual Smoke, keine Wild/Foe/Items/Misc/Type-Chaos-Kombis |
...
| P1 | Palette Randomization | exact coverage batch 09 passed mit Caveat; isolated smoke input prepared | `FVX-GFX-001` bis `FVX-GFX-004` | CLI log-smoke clean, aber Ingame Visual Smoke und Writer-Risiko bleiben offen; vorbereitetes Manual-Profil ist noch kein Smoke-Beweis | Palette Visual Smoke / Preserve-Repoint-Fix, isoliert ohne Wild/Foe/Items/Misc/Type-Chaos | 058, 197, 201 |
...
| 8 | Palette Randomization | echte Palettenaenderungen visuell absichern | exact coverage CLI passed und lokales isoliertes Manual-Profil vorbereitet, aber Visual Smoke fehlt | `FVX-GFX-001` bis `FVX-GFX-004` nur nach lokalem Smoke de-caveaten |

...
|---|---|
| Stand | Nach UPR-FVX PR #127 Fast-Egg-Hatching-Null-`BreedingInfo`-Guard, PR #126 Catching-Tutorial-Species-Mapping, PR #125 Running-Shoes-Misc-Tweaks, Misc Tweaks Behavior Smoke 210, PR #124 Expanded-Trainer-Logging-Fallback, PR #123 Gen3/CFRU-DPE Palette-Output-Writes, Graphics/Palettes Visual Smoke 209, PR #118 Wild Encounter Base-vs-Output Audit, Combined Trainer Visual Runtime Smoke 208, UPR-FVX PR #117 Rival-Counter-Starter/Intro-Species-0-Fix und combined visual smoke, PR #116 finalem Trainer Class Sprite Sync Smoke, PR #109 Intro-Mon Visual-Source-Fix-Smoke, PR #107/#108 Intro-Mon Visual-Source-Diagnose, PR #106 Pre/Post Runtime-Trainer-Audit, PR #105 Runtime-Source-Trainer-Randomization-Smoke, PR #104 Strict-Runtime-Trainer-Source-Sync, coverage-generated CLI profile matrix run und exact-coverage Batches 01 bis 18 CLI-Log-Smokes |

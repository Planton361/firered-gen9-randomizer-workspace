...
| Zuletzt entblockt | Combined Trainer Visual Runtime Smoke 208 bestaetigt `PASS_WITH_CAVEATS`: Intro Mon sichtbar randomisiert, Player starter Charmander, Oak-Lab Rival starter Squirtle, Route-22-Rival-Sprite randomisiert und konsistent mit Oak-Lab-Rival-Sprite, Viridian-Forest-Trainer-Sprites randomisiert und keine crashes/freezes beobachtet; UPR-FVX PR #117 fixt `Rival Carries Starter Through Game` nach Foe Pokemon Randomization und verhindert Intro-Mon-Species-0-Writes im extended CFRU/DPE BPRE-Pool; PR #116 finalisiert `MODE-TRAINER-CLASS-SPRITE-SYNC`: `Randomize Trainer Names` bleibt personal-name-only; `Randomize Trainer Class Names` bleibt ohne Sync legacy/textlabel-only; mit Sync folgen Class label, `trainerClass` und sichtbarer `trainerPic` der Class-Assignment; sanitized local smoke bestaetigt per-trainer Regular assignments, gruppierte Rival/Friend class/sprite consistency, eligible Runtime-Source-Sync und keine gemeldeten garbled sprites/crashes; PR #109 fixt die CFRU/DPE Gen9 BPRE Intro-Mon Visual-Source fuer den bestaetigten Nidoran-female Asset-Table-Scope |
| Aktuelle Caveats | Combined Trainer Visual Runtime Smoke 208 bleibt `PASS_WITH_CAVEATS`: Route-22-Rival-Starter-Carry wurde nicht voll inspiziert, weil ein randomisiertes Nicht-Starter-Rival-Pokemon Lv9 Silvally den Spieler besiegte; kein Full-Playthrough, keine all-starter-choice matrix und keine P1-Promotion; Trainer Class Sprite Sync ist targeted visual-smoke-bestaetigt, aber kein Full-Playthrough, keine globale Route-/Kategorie-Abdeckung und keine P1-Promotion; Intro-Mon Species-0-Regressionsfix ist targeted smoke-bestaetigt, aber keine globale Intro-Mon-Speziesabdeckung; Runtime-source strict sync plus randomizer eligibility ist fuer Viridian Forest `531/532` lokal bestaetigt, aber keine breite Trainer/Foe-P1-Promotion; `loaded-mismatch`, invalid-pointer, empty-party und out-of-range rows sowie Full-Playthrough bleiben Diagnose-/Follow-up-Scope; Graphics/Palettes und Misc Tweaks brauchen Visual-/Behavior-Smokes; Gen-Limit-1-9 `MODE-*` Overlays bleiben unsupported by Settings format; Special-Wild/Day-Night/Swarms bleiben separater Scope |
| Keine P1-Promotion | Aktuelle Updates sind Workspace-/Smoke-Status, keine neue P1-Freigabe |
| Naechster sinnvoller Block | Route-22-Rival-Starter-Carry nur bei Bedarf direkt nachsmoken, weil 208 den Sprite bestaetigt, aber den Starter wegen Lv9 Silvally nicht voll inspizierte; Rival Carry sonst nur bei breiterer all-starter-/later-appearance-Sampling-Frage erneut vertiefen; Trainer-Class-Sprite-Sync nur noch bei Regression oder breiterer Sampling-Frage weiter vertiefen; danach `loaded-mismatch`/`invalid` Runtime-Source-Rows separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; gezielt Ingame-/Visual-/Behavior-Smokes isolieren: Trainer Held Items Sensible, Graphics/Palettes, Misc Tweaks und Special-Wild |
...
| Foe Pokemon / Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Rival Carry targeted-smoke passed / Trainer Class Sprite Sync targeted-smoke passed / Combined trainer visual runtime smoke passed with caveats | Trainer Pokemon core, Trainer Movesets, Trainer Names; `FVX-FOE-001` bis `014` and exact Foe mode overlays CLI log-smoked; Rival Carries Starter Through Game targeted-smoke-confirmed for Player Charmander -> Oak-Lab Rival Squirtle after Foe Pokemon randomization; 208 bestaetigt Route-22-Rival-Sprite consistency, aber Route-22-Rival-Starter-Carry blieb partial; `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted-smoke-confirmed for class label/classId/pic consistency; Viridian Forest trainer sprites randomized in 208; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Battle Style, Full-Rival-Carry, Trainer Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked or documented | Rival Carry targeted smoke covers one sampled Oak-Lab counter path, not all starter choices or full playthrough; 208 Route-22-Rival-Starter-Carry stayed partial because Lv9 Silvally defeated the player before starter inspection; Runtime-source `531/532` Trainer Pokemon path is locally smoke-confirmed, but broader loaded-mismatch/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync is targeted visual-smoke-confirmed only; without Sync Trainer Class Names remains legacy/textlabel-only; Sensible Held Items braucht fokussierte Isolation | Route-22-Rival-Starter-Carry nur bei Bedarf direkt nachsmoken; `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Sensible Items, Graphics/Palettes und Misc Tweaks isolieren; Rival Carry und Trainer-Class-Sprite-Sync nur bei Regression/breiterem Sampling erneut vertiefen | 190, 191, 197, 198, 199, 201, 202, 203, 204, 206, 207, 208, PR116, PR117 |
...
| Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Trainer Class Sprite Sync targeted-smoke passed / Combined trainer visual runtime smoke passed with caveats | Species, Movesets, Trainer Names; `MODE-TRAINER-CLASS-SPRITE-SYNC` fuer class label/classId/pic consistency targeted-smoke-confirmed; 208 bestaetigt Viridian-Forest-Trainer-Sprites randomisiert und Route-22-Rival-Sprite konsistent mit Oak-Lab-Rival-Sprite; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Special Rules, Battle Style, Full-Rival-Carry, Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked/documented | Broader `loaded-mismatch`/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync targeted smoke is not full-playthrough proof; without Sync Trainer Class Names remains legacy/textlabel-only; 208 Route-22-Rival-Starter-Carry blieb partial, weil Lv9 Silvally den Spieler vor Starter-Inspection besiegte; Sensible Held Items und Full-Rival-Carry brauchen fokussierte Ingame-Smokes | Route-22-Rival-Starter-Carry nur bei Bedarf direkt nachsmoken; `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Sensible Items isolieren; Trainer-Class-Sprite-Sync nur bei Regression/breiterem Sampling erneut vertiefen |
...
| 70 | `FVX-FOE-012` | Foe Pokemon | Rival Carries Starter Through Game | Targeted visual smoke passed with caveat | Player Charmander -> Oak-Lab Rival Squirtle; Route-22 starter not inspected because Lv9 Silvally defeated player; no P1 promotion |
...
| P1 | Rival Carries Starter Through Game | targeted visual smoke passed with caveat | `FVX-FOE-012` | Player Charmander -> Oak-Lab Rival Squirtle lokal bestaetigt; Route-22 starter not inspected because Lv9 Silvally defeated player; kein Full-Playthrough und keine all-starter-choice matrix | Route-22 starter carry nur bei Bedarf direkt nachsmoken; keine P1-Promotion | 179, 192, 201, 207, 208, PR117 |
...
| 3 | Rival Carries Starter Through Game | weitere Starter-/Rival-Auftritte samplen | ein Oak-Lab Counter-Pfad ist targeted-smoke-bestaetigt; 208 bestaetigt Route-22 Rival sprite consistency, aber Route-22 starter carry blieb partial; keine all-starter-choice matrix und kein Full-Playthrough | Route-22 starter carry nur bei Bedarf direkt nachsmoken; breiteres lokales Sampling nur bei Bedarf |
...
|---|---|---|---|
| 208 Combined Trainer Visual Runtime Smoke | Combined Trainer Visual Runtime | Intro Mon sichtbar randomisiert; Player starter Charmander; Oak-Lab Rival starter Squirtle; Route-22-Rival-Sprite konsistent mit Oak-Lab-Rival-Sprite; Viridian-Forest-Trainer-Sprites randomisiert; keine crashes/freezes beobachtet | `PASS_WITH_CAVEATS`; Route-22-Rival-Starter-Carry partial, weil Lv9 Silvally den Spieler vor Starter-Inspection besiegte; keine P1-Promotion |

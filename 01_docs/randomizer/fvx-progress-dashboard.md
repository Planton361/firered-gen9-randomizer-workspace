...
|---|---|
| Stand | Nach Type Effectiveness Battle Smoke 211, UPR-FVX PR #127 Fast-Egg-Hatching-Null-`BreedingInfo`-Guard, PR #126 Catching-Tutorial-Species-Mapping, PR #125 Running-Shoes-Misc-Tweaks, Misc Tweaks Behavior Smoke 210, PR #124 Expanded-Trainer-Logging-Fallback, PR #123 Gen3/CFRU-DPE Palette-Output-Writes, Graphics/Palettes Visual Smoke 209, PR #118 Wild Encounter Base-vs-Output Audit, Combined Trainer Visual Runtime Smoke 208, UPR-FVX PR #117 Rival-Counter-Starter/Intro-Species-0-Fix und combined visual smoke, PR #116 finalem Trainer Class Sprite Sync Smoke, PR #109 Intro-Mon Visual-Source-Fix-Smoke, PR #107/#108 Intro-Mon Visual-Source-Diagnose, PR #106 Pre/Post Runtime-Trainer-Audit, PR #105 Runtime-Source-Trainer-Randomization-Smoke, PR #104 Strict-Runtime-Trainer-Source-Sync, coverage-generated CLI profile matrix run und exact-coverage Batches 01 bis 18 CLI-Log-Smokes |
| UPR-FVX-Pin im Workspace | `155fac0b33474f6ed5b3fbaed7dd9bf24b4e1315` |
...
| Zuletzt entblockt | Type Effectiveness Battle Smoke 211 bestaetigt `PASS_TARGETED_BATTLE_SMOKE_WITH_CAVEATS`: lokaler Battle-Smoke, Effektivitaetsverhalten wirkte passend und keine Battle-Crashes gemeldet; Misc Tweaks Behavior Smoke 210 bestaetigt `PASS_TARGETED_BEHAVIOR_SMOKE_WITH_CAVEATS`: Fastest Text pass, PC Potion pass, Run Without Running Shoes pass, Running Shoes Indoors pass, Catching Tutorial pass ohne Fragezeichen-Sprite/-Name, Fast Egg Hatching crash-free randomization/output-load, Ban Lucky Egg likely pass / no issue observed und keine crashes/freezes in getesteten Pfaden; UPR-FVX PR #125 fixt CFRU/DPE BPRE Running-Shoes-Misc-Tweaks, PR #126 fixt CFRU/DPE BPRE Catching-Tutorial-Species-Mapping, PR #127 fixt Fast Egg Hatching auf Species ohne `BreedingInfo`; Graphics/Palettes Visual Smoke 209 bestaetigt targeted visual/audit pass mit Caveats: `Pokemon Palettes: Randomized/Changed`, CFRU-DPE palette copy save `normalPaletteWriteAttempts=841`, Palette Audit `sampledCount=21`, `normalChangedCount=21`, `shinyChangedCount=0`, `unchangedCount=0`, sampled normal palettes fuer Charmander/Squirtle/Caterpie/Pikachu/Blissey changed from base, sichtbare geaenderte Paletten und kein finales `Error during logging`; UPR-FVX PR #123 schreibt Gen3/CFRU/DPE Palette-Randomization-Output, PR #124 verhindert den Expanded-Trainer-Logging-Crash; UPR-FVX PR #118 stellt den opt-in Wild Encounter Base-vs-Output Audit bereit; Combined Trainer Visual Runtime Smoke 208 bestaetigt `PASS_WITH_CAVEATS`; PR #117 fixt Rival-Counter-Starter/Intro-Species-0; PR #116 finalisiert `MODE-TRAINER-CLASS-SPRITE-SYNC`; PR #109 fixt die CFRU/DPE Gen9 BPRE Intro-Mon Visual-Source |
| Aktuelle Caveats | Type Effectiveness 211 ist targeted battle smoke, keine vollstaendige Type-Matchup-Matrix, kein Full-Playthrough und keine P1-Promotion; Misc Tweaks 210 ist targeted behavior smoke, kein Full-Playthrough, kein Full-Hatch-Cycle-Proof, keine dedizierte Ban-Lucky-Egg-Proof-Evidence und keine P1-Promotion; Reusable TMs und Forgettable HMs sind CFRU-provided und sollen nicht doppelt durch das UPR-FVX stable profile aktiviert werden; Graphics/Palettes 209 ist targeted visual/audit smoke, kein Full-Playthrough, keine breite species/form coverage, keine Shiny-Proof-Abdeckung (`shinyChangedCount=0`) und keine P1-Promotion; Wild Encounter Base-vs-Output Audit ist diagnostic-only und deckt den modeled Gen3 base `WildPokemon` table path ab; CFRU/DPE special/runtime wild sources bleiben Follow-up, falls Audit und Ingame-Beobachtung auseinanderlaufen; Combined Trainer Visual Runtime Smoke 208 bleibt `PASS_WITH_CAVEATS`; Trainer Class Sprite Sync ist targeted visual-smoke-bestaetigt, aber kein Full-Playthrough, keine globale Route-/Kategorie-Abdeckung und keine P1-Promotion; Runtime-source strict sync plus randomizer eligibility ist fuer Viridian Forest `531/532` lokal bestaetigt, aber keine breite Trainer/Foe-P1-Promotion; Gen-Limit-1-9 `MODE-*` Overlays bleiben unsupported by Settings format; Special-Wild/Day-Night/Swarms bleiben separater Scope |
| Keine P1-Promotion | Aktuelle Updates sind Workspace-/Smoke-Status, keine neue P1-Freigabe |
| Naechster sinnvoller Block | Type Effectiveness nur bei Regression oder fuer eine vollstaendige Type-Matchup-Matrix erneut vertiefen; Misc Tweaks nur bei Regression oder fuer Full-Hatch-/Ban-Lucky-Egg-/nicht beobachtete Detailpfade erneut vertiefen; wenn Graphics/Palettes weiter vertieft wird, shiny-fokussierte Palette-Audit-/Visual-Evidence und breitere Species/Form-Samples lokal und sanitisiert sammeln; wenn Wild-Log und Ingame-Wild auseinanderlaufen, lokalen privaten Base-vs-Output Wild Audit aus PR #118 nutzen und nur sanitized Summaries dokumentieren; CFRU/DPE special/runtime wild sources separat triagieren, falls modeled-table Audit und Ingame divergieren; Rival Carry nur bei breiterer all-starter-/later-appearance-Sampling-Frage erneut vertiefen; Trainer-Class-Sprite-Sync nur noch bei Regression oder breiterer Sampling-Frage weiter vertiefen; danach `loaded-mismatch`/`invalid` Runtime-Source-Rows separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Trainer Held Items Sensible bleibt ein isolierter Behavior-Smoke-Kandidat |
...
|---|---|---|---|---|---|---|
| General Options | exact coverage passed mit Caveat / Intro visual fix targeted-smoke passed / Species-0 regression fixed / no P1 promotion | `FVX-GEN-001`, `FVX-GEN-002` CLI log-smoked; Intro random mode overlay log-smoked; PR #107/#108 dokumentieren Intro-Mon-Setting-Semantik und Visual-Source-Diagnose; PR #109 targeted smoke bestaetigt sichtbaren Oak-Intro-Sprite-Wechsel weg von Nidoran female; PR #117 targeted smoke bestaetigt sichtbaren Blissey Intro Mon und keine Species-0-Regression; 208 Combined Trainer Visual Runtime Smoke bestaetigt sichtbar randomisierten Intro Mon | - | Race Mode bleibt offen; Intro Visual-Source-/Species-0-Fix ist targeted Smoke, kein Full-Playthrough; Gen-Limit-1-9 `MODE-*` Overlays bleiben unsupported by Settings format | weitere Intro Mon Evidence nur bei Regression/Full-Playthrough; General-/Race-Smoke spaeter | 064, 197, 198, 201, 205, 207, 208, PR109, PR117 |
...
| Foe Pokemon / Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Rival Carry targeted-smoke passed / Trainer Class Sprite Sync targeted-smoke passed / Combined trainer visual runtime smoke passed with caveats | Trainer Pokemon core, Trainer Movesets, Trainer Names; `FVX-FOE-001` bis `014` and exact Foe mode overlays CLI log-smoked; Rival Carries Starter Through Game targeted-smoke-confirmed for Player Charmander -> Oak-Lab Rival Squirtle and Route-22 Rival Squirtle after Foe Pokemon randomization; 208 bestaetigt Route-22-Rival-Sprite consistency; Route-22 Rival non-starter Pokemon Silvally Lv9 demonstrates that non-starter Rival Pokemon remain eligible for Foe Pokemon randomization; `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted-smoke-confirmed for class label/classId/pic consistency; Viridian Forest trainer sprites randomized in 208; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Battle Style, Full-Rival-Carry, Trainer Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked or documented | Rival Carry targeted smoke covers one sampled starter path, not all starter choices or full playthrough; Runtime-source `531/532` Trainer Pokemon path is locally smoke-confirmed, but broader loaded-mismatch/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync is targeted visual-smoke-confirmed only; without Sync Trainer Class Names remains legacy/textlabel-only; Sensible Held Items braucht fokussierte Isolation | `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Sensible Items, Graphics/Palettes und Misc Tweaks isolieren; Rival Carry und Trainer-Class-Sprite-Sync nur bei Regression/breiterem Sampling erneut vertiefen | 190, 191, 197, 198, 199, 201, 202, 203, 204, 206, 207, 208, PR116, PR117 |
...
|---|---|---|---|---|---|
| General Options | exact coverage passed fuer `FVX-GEN-001/002` mit Gen-Limit-Caveat; Intro visual fix targeted-smoke passed | Limit Pokemon, No Premature Evolutions and Intro random mode CLI log-smoked; `No Random Intro Mon` negative GUI-Option und `randomizeIntroMon=true` aktiver Pfad dokumentiert; sichtbarer Oak-Intro-Sprite wechselte nach PR #109 weg von Nidoran female; 208 Combined Trainer Visual Runtime Smoke bestaetigt sichtbar randomisierten Intro Mon | - | Race Mode bleibt offen; Intro-Fix ist targeted Smoke, kein Full-Playthrough; Gen-Limit-1-9 `MODE-*` Overlays unsupported by Settings format | weitere Intro Mon Evidence nur bei Regression/Full-Playthrough; General-/Race-Smoke spaeter |
...
| Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Trainer Class Sprite Sync targeted-smoke passed / Combined trainer visual runtime smoke passed with caveats | Species, Movesets, Trainer Names; `MODE-TRAINER-CLASS-SPRITE-SYNC` fuer class label/classId/pic consistency targeted-smoke-confirmed; 208 bestaetigt Viridian-Forest-Trainer-Sprites randomisiert, Route-22-Rival-Sprite konsistent mit Oak-Lab-Rival-Sprite und Route-22 Rival starter Squirtle; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Special Rules, Battle Style, Full-Rival-Carry, Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked/documented | Broader `loaded-mismatch`/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync targeted smoke is not full-playthrough proof; without Sync Trainer Class Names remains legacy/textlabel-only; Silvally Lv9 on Route 22 is documented as randomized non-starter Rival Pokemon, not as starter-carry failure; Sensible Held Items und Full-Rival-Carry brauchen fokussierte Ingame-Smokes | `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Sensible Items isolieren; Trainer-Class-Sprite-Sync nur bei Regression/breiterem Sampling erneut vertiefen |
...
| 3 | `FVX-GEN-003` | General Options | No Random Intro Mon | Intro visual fix targeted-smoke passed; no P1 promotion | Negative GUI option; `MODE-NO-RANDOM-INTRO` / `FVX-GEN-003` set `randomizeIntroMon=false`; PR #109 fixes confirmed CFRU/DPE visual source; 208 confirms visibly randomized Intro Mon in combined trainer visual runtime smoke; full-playthrough still open |
...
| 70 | `FVX-FOE-012` | Foe Pokemon | Rival Carries Starter Through Game | Targeted visual smoke passed with caveat | Player Charmander -> Oak-Lab Rival Squirtle and Route-22 Rival Squirtle; Silvally Lv9 was a randomized non-starter Rival Pokemon; no P1 promotion |
| 71 | `FVX-FOE-013` | Foe Pokemon | Randomize Trainer Names / Class Names | Trainer Names passed; Class Names textlabel-only without Sync; Sprite Sync targeted-smoke passed | `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted visual smoke; regular per-trainer assignments; Rival/Friend grouped consistency; 208 confirms Route-22 Rival sprite consistency and Viridian Forest trainer sprites randomized; no P1 promotion |
...
| P1 | Rival Carries Starter Through Game | targeted visual smoke passed with caveat | `FVX-FOE-012` | Player Charmander -> Oak-Lab Rival Squirtle und Route-22 Rival Squirtle lokal bestaetigt; Silvally Lv9 war ein randomisiertes Non-Starter-Rival-Pokemon; kein Full-Playthrough und keine all-starter-choice matrix | breiteres Sampling nur bei Bedarf; keine P1-Promotion | 179, 192, 201, 207, 208, PR117 |
...
| P1 | Trainer Names/Class Names / Sprite Sync | Trainer Names passed; Class Names textlabel-only without Sync; Sprite Sync targeted-smoke passed | `FVX-FOE-013` | `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted visual-smoke-confirmed; 208 bestaetigt Route-22 Rival sprite consistency und Viridian Forest trainer sprites randomized; aber kein Full-Playthrough und keine P1-Promotion; ohne Sync bleibt legacy/textlabel-only | nur bei Regression oder breiterem Sampling erneut vertiefen; keine P1-Promotion | 190, 206, 208, PR116 |
...
| 2 | Stable Visual Profile + Starter Pokemon + Intro Mon | groesstes aktuelles Normalprofil laenger samplen | Stable Visual Profile passed, Oak-Lab Rival Sync passed, PR #117 combined visual smoke passed, 208 combined trainer visual runtime smoke `PASS_WITH_CAVEATS` und Intro Mon visual fix targeted-smoke passed | lokaler Smoke nur bei Bedarf mit Starters ON, Intro Mon ON, Trainer Class Names nach Scope, Special-Wild OFF |
| 3 | Rival Carries Starter Through Game | weitere Starter-/Rival-Auftritte samplen | ein Counter-Pfad ist fuer Oak-Lab und Route 22 targeted-smoke-bestaetigt; keine all-starter-choice matrix und kein Full-Playthrough | breiteres lokales Sampling nur bei Bedarf |
...
| 5 | Trainer Class Sprite Sync Sampling | nur bei Regression oder breiterer Kategoriefrage erneut pruefen | `MODE-TRAINER-CLASS-SPRITE-SYNC` targeted-smoke-confirmed; ohne Sync bleibt Class Names textlabel-only | kein aktueller Fixbedarf; keine P1-Promotion |
...
| 8 | Palette Randomization | Shiny-/Breitensampling nachziehen | targeted visual/audit smoke 209 passed with caveats: sampled normal palettes changed and visual changes observed; shiny sample unchanged | `FVX-GFX-001` bis `FVX-GFX-004` bleiben ohne P1, Shiny gesondert absichern |
...
| 10 | Graphics/Sprites / Misc Detailpfade | Custom Graphics modellieren; Misc nur bei Regression oder Detailfragen nachtesten | Palettes targeted smoke passed with caveats; Misc targeted behavior smoke passed with caveats | P2-Entscheidung fuer Custom Graphics; Misc Detailpfade nur separat |

...
|---|---|
| Stand | Nach Gen Limit / Special Form / Mechanic Item Smoke 212 und UPR-FVX compat-Merge `765d8ec0ab298bbaab4aa9f8f31b93c7259a47e5` bis PR #150, Type Effectiveness Battle Smoke 211, UPR-FVX PR #127 Fast-Egg-Hatching-Null-`BreedingInfo`-Guard, PR #126 Catching-Tutorial-Species-Mapping, PR #125 Running-Shoes-Misc-Tweaks, Misc Tweaks Behavior Smoke 210, PR #124 Expanded-Trainer-Logging-Fallback, PR #123 Gen3/CFRU-DPE Palette-Output-Writes, Graphics/Palettes Visual Smoke 209, PR #118 Wild Encounter Base-vs-Output Audit, Combined Trainer Visual Runtime Smoke 208, UPR-FVX PR #117 Rival-Counter-Starter/Intro-Species-0-Fix und combined visual smoke, PR #116 finalem Trainer Class Sprite Sync Smoke, PR #109 Intro-Mon Visual-Source-Fix-Smoke, PR #107/#108 Intro-Mon Visual-Source-Diagnose, PR #106 Pre/Post Runtime-Trainer-Audit, PR #105 Runtime-Source-Trainer-Randomization-Smoke, PR #104 Strict-Runtime-Trainer-Source-Sync, coverage-generated CLI profile matrix run und exact-coverage Batches 01 bis 18 CLI-Log-Smokes |
| UPR-FVX-Pin im Workspace | `765d8ec0ab298bbaab4aa9f8f31b93c7259a47e5` |
...
| Trainer | Working-matrix passed mit Caveat / exact coverage passed / Runtime-source 531-532 smoke passed / Trainer Class Sprite Sync targeted-smoke passed and GUI-exposed / Combined trainer visual runtime smoke passed with caveats | Species, Movesets, Trainer Names; `MODE-TRAINER-CLASS-SPRITE-SYNC` fuer class label/classId/pic consistency targeted-smoke-confirmed and now GUI-exposed per Evidence 212; 208 bestaetigt Viridian-Forest-Trainer-Sprites randomisiert, Route-22-Rival-Sprite konsistent mit Oak-Lab-Rival-Sprite und Route-22 Rival starter Squirtle; Evidence 212 bestaetigt Oak-Lab Rival counter-starter is preserved independently of Rival Carries Starter Through Game; strict `VALID_RUNTIME_NOT_LOADED` runtime-source sync merged; generic `RUNTIME-SOURCE` trainers randomizer-eligible; Viridian Forest `531/532` locally confirmed; randomized output audit `unloaded-valid-parties total=0`; Rival 2 `329/330/331` and Brock `414` randomized in sanitized observations | Additional Pokemon, Type Diversity / Type Themes, Special Rules, Battle Style, Full-Rival-Carry, Held Items, Trainer Class Sprite Sync and exact Foe modes log-smoked/documented | Broader `loaded-mismatch`/invalid/out-of-range rows and full playthrough remain Follow-up; Trainer Class Sprite Sync targeted smoke is not full-playthrough proof and should be enabled when Trainer Class Names are randomized; Silvally Lv9 on Route 22 is documented as randomized non-starter Rival Pokemon, not as starter-carry failure; Sensible Held Items und Full-Rival-Carry brauchen fokussierte Ingame-Smokes | `loaded-mismatch`/`invalid` separat triagieren; weitere suspected runtime-source battles nur mit eigener sanitized Evidence aufnehmen; Sensible Items isolieren; Trainer-Class-Sprite-Sync nur bei Regression/breiterem Sampling erneut vertiefen |
...
|---|---|---|---|
| 212 Gen Limit / Special Form / Mechanic Item Smoke | Gen-Limit / Special Forms / Items | UPR-FVX compat pin `765d8ec0ab298bbaab4aa9f8f31b93c7259a47e5`; Gen-Limit 1-9 infrastructure works; Gen1-only and Gen1-6 log smokes looked correct; Gen7/8/9 Intro Mon no longer crashes; Special-form filtering works in latest checks; Trainer Class Sprite Sync GUI-exposed; Oak-Lab Rival counter-starter preserved; mechanic item filtering uses source-backed CFRU/DPE categories | `PASS_TARGETED_LOG_VISUAL_SMOKE_WITH_CAVEATS`; no full playthrough, no P1 promotion; Plates/Drives/Memories/Nectars policy, Static Script/Gift/NPC item sources and custom/future form encodings remain caveated |

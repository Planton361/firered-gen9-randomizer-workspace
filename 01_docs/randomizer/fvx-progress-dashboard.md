...
|---|---|
| Stand | Nach UPR-FVX PR #107 Intro-Mon Visual-Source-Diagnose, PR #106 Pre/Post Runtime-Trainer-Audit, PR #105 Runtime-Source-Trainer-Randomization-Smoke, PR #104 Strict-Runtime-Trainer-Source-Sync, coverage-generated CLI profile matrix run und exact-coverage Batches 01 bis 18 CLI-Log-Smokes |
| UPR-FVX-Pin im Workspace | `a7e098a5158d824b1ddec62a286f2a6ffafce8e4` |
...
|---|---|---|---|---|---|---|
| General Options | exact coverage passed mit Caveat / Intro diagnostic available / no P1 promotion | `FVX-GEN-001`, `FVX-GEN-002` CLI log-smoked; Intro random mode overlay log-smoked; PR #107 dokumentiert Intro-Mon-Setting-Semantik und Visual-Source-Diagnose | - | Race Mode bleibt offen; Intro Visual-Source-Diagnose ist kein Visual-Fix; Gen-Limit-1-9 `MODE-*` Overlays bleiben unsupported by Settings format | lokaler Intro Visual-Source Base-vs-Output-Report und separater General-/Intro-Ingame-Smoke | 064, 197, 198, 201, PR107 |
...
|---|---|---|---|---|---|
| General Options | exact coverage passed fuer `FVX-GEN-001/002` mit Gen-Limit-Caveat; Intro diagnostic available | Limit Pokemon, No Premature Evolutions and Intro random mode CLI log-smoked; `No Random Intro Mon` negative GUI-Option und `randomizeIntroMon=true` aktiver Pfad dokumentiert | - | Race Mode und Intro-Visual-Fix bleiben offen; Gen-Limit-1-9 `MODE-*` Overlays unsupported by Settings format | Intro Visual-Source-Diagnose lokal auswerten; General-/Intro-Smoke spaeter |
...
| 3 | `FVX-GEN-003` | General Options | No Random Intro Mon | Intro diagnostic available; no P1 promotion | Negative GUI option; `MODE-NO-RANDOM-INTRO` / `FVX-GEN-003` set `randomizeIntroMon=false`; visual fix still open |

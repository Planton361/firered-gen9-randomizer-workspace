...
CFRU/DPE Global Species Pool Regression-Smoke ist sanitisiert dokumentiert. Ergebnisprotokoll: `08_tests/randomizer/064_p1_global_species_pool_regression_smoke_results.md`.

## Priorisierte naechste Arbeitsbloecke

1. `test/upr-fvx-cfru-dpe-p1-starters-suboptions-regression-smoke`
   - Die in 063 geplanten Starter-Suboptions-Slices lokal ausfuehren, ohne Starter Held Items und ohne offene Writer.

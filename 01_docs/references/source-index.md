...
|---|---|---|---|---|---|
| Ironmon Regeln / Patches | PyroMikeGit/SuperKaizoIronMON | https://github.com/PyroMikeGit/SuperKaizoIronMON | Öffentliche Super-Kaizo-IronMON-Regeln, Smart-AI-Patch-/Randomizer-Hinweise und Release-Links | read-only Web-Pruefung; keine Patch-/Release-Downloads | dokumentiert |
| Ironmon Smart AI Randomizer | Smart AI Randomizer v2 Release | https://github.com/PyroMikeGit/SuperKaizoIronMON/releases/tag/smart-ai-v2 | Öffentliche Release-Beschreibung für Smart-AI-Randomizer und NatDex-Hinweis | read-only Web-Pruefung; keine Assets heruntergeladen | dokumentiert |
| FireRed Smart-AI Source Pointer | tom-overton/pokefirered `smart-ai` | https://github.com/tom-overton/pokefirered/tree/smart-ai | Öffentlicher Source-Pointer für historische FireRed-Smart-AI-Arbeit | read-only Web-Pruefung; nicht geklont, nicht gebaut | offen / nicht lokal verifiziert |

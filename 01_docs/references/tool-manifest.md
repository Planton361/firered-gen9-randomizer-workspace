...
Dieser Stand dokumentiert den Arbeitsblock `compat/upr-fvx-cfru-dpe-tm-hm-scope-and-safety`. UPR-FVX wurde im Planton361-Fork-Submodule gezielt geaendert und gebaut; lokale ROM-/Log-/Output-Artefakte blieben ignored unter `05_builds/**` und wurden nicht committed. Tool-Binaries, Release-Assets, Secrets und private Pfade wurden nicht dokumentiert.
...
Der aktuelle Arbeitsblock pinnt den Workspace auf den UPR-FVX-TM/HM-Scope-and-Safety-Fix-Commit fuer CFRU/DPE.

| Tool/Repo | Zweck | Upstream | Fork/Origin | Lokaler Pfad | Branch | Commit | Codex darf ändern | Status |
|---|---|---|---|---|---|---|---|---|
| Workspace Repo | Source of Truth | n/a | git@github.com:Planton361/firered-gen9-randomizer-workspace.git | Workspace-Root | `compat/upr-fvx-cfru-dpe-tm-hm-scope-and-safety` | offen | ja, nur Branches | aktiv |
...
Arbeitsblock: `compat/upr-fvx-cfru-dpe-tm-hm-scope-and-safety`.

| Repo | Zweck | Origin | Lokaler Pfad | Branch | Commit | Codex darf aendern | Status |
|---|---|---|---|---|---|---|---|
| UPR-FVX Fork | Haupt-Randomizer-Fork | `https://github.com/Planton361/universal-pokemon-randomizer-fvx.git` | `02_external/upr-fvx` | `compat/upr-fvx-cfru-dpe-tm-hm-scope-and-safety` | `32e43ac03a5762542773213a13be4e0389f1deae` | ja, nur in diesem Branch | TM/HM-Scope-and-Safety-Fix fuer CFRU/DPE; basiert auf `c71fd75e` |
...
| Arbeitsbranch | `compat/upr-fvx-cfru-dpe-tm-hm-scope-and-safety` |
| Gepinnter Workspace-Stand | `32e43ac03a5762542773213a13be4e0389f1deae` auf `compat/upr-fvx-cfru-dpe-tm-hm-scope-and-safety`; enthaelt den CFRU/DPE-TM/HM-Scope-and-Safety-Fix auf Basis des Move-Data-Reader-Fix `c71fd75e` |

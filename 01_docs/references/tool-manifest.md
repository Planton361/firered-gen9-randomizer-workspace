...
Dieser Stand dokumentiert den Arbeitsblock `compat/upr-fvx-cfru-dpe-learnset-gui-flow-safety`. UPR-FVX wurde im Planton361-Fork-Submodule gezielt geaendert und gebaut; lokale ROM-/Log-/Output-Artefakte blieben ignored unter `05_builds/**` und wurden nicht committed. Tool-Binaries, Release-Assets, Secrets und private Pfade wurden nicht dokumentiert.
...
Der aktuelle Arbeitsblock pinnt den Workspace auf den UPR-FVX-Learnset-GUI-Flow-Safety-Fix-Commit fuer CFRU/DPE.

| Tool/Repo | Zweck | Upstream | Fork/Origin | Lokaler Pfad | Branch | Commit | Codex darf ändern | Status |
|---|---|---|---|---|---|---|---|---|
| Workspace Repo | Source of Truth | n/a | git@github.com:Planton361/firered-gen9-randomizer-workspace.git | Workspace-Root | `compat/upr-fvx-cfru-dpe-learnset-gui-flow-safety` | offen | ja, nur Branches | aktiv |
...
Arbeitsblock: `compat/upr-fvx-cfru-dpe-learnset-gui-flow-safety`.

| Repo | Zweck | Origin | Lokaler Pfad | Branch | Commit | Codex darf aendern | Status |
|---|---|---|---|---|---|---|---|
| UPR-FVX Fork | Haupt-Randomizer-Fork | `https://github.com/Planton361/universal-pokemon-randomizer-fvx.git` | `02_external/upr-fvx` | `compat/upr-fvx-cfru-dpe-learnset-gui-flow-safety` | `086d2a9177df7624a0e7ca1876b210a200d7aa98` | ja, nur in diesem Branch | Learnset GUI Flow Safety Fix fuer CFRU/DPE; basiert auf Learnset-Write-Repointing-Fix `77de517d` |
...
| Gepinnter Workspace-Stand | `086d2a9177df7624a0e7ca1876b210a200d7aa98` auf `compat/upr-fvx-cfru-dpe-learnset-gui-flow-safety`; enthaelt den CFRU/DPE-Learnset-GUI-Flow-Safety-Fix auf Basis des Learnset-Write-Repointing-Fix `77de517d` |

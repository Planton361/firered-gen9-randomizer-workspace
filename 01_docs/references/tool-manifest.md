...
Dieser Stand dokumentiert den Arbeitsblock `compat/upr-fvx-cfru-dpe-base-stats-types-scope-and-write`. UPR-FVX wurde im Planton361-Fork-Submodule gezielt geaendert und gebaut; lokale ROM-/Log-/Output-Artefakte blieben ignored unter `05_builds/**` und wurden nicht committed. Tool-Binaries, Release-Assets, Secrets und private Pfade wurden nicht dokumentiert.
...
Der aktuelle Arbeitsblock pinnt den Workspace auf den UPR-FVX-BaseStats-/Types-Scope-and-Write-Fix-Commit fuer CFRU/DPE.

| Tool/Repo | Zweck | Upstream | Fork/Origin | Lokaler Pfad | Branch | Commit | Codex darf ändern | Status |
|---|---|---|---|---|---|---|---|---|
| Workspace Repo | Source of Truth | n/a | git@github.com:Planton361/firered-gen9-randomizer-workspace.git | Workspace-Root | `compat/upr-fvx-cfru-dpe-base-stats-types-scope-and-write` | offen | ja, nur Branches | aktiv |
...
Arbeitsblock: `compat/upr-fvx-cfru-dpe-base-stats-types-scope-and-write`.

| Repo | Zweck | Origin | Lokaler Pfad | Branch | Commit | Codex darf aendern | Status |
|---|---|---|---|---|---|---|---|
| UPR-FVX Fork | Haupt-Randomizer-Fork | `https://github.com/Planton361/universal-pokemon-randomizer-fvx.git` | `02_external/upr-fvx` | `compat/upr-fvx-cfru-dpe-base-stats-types-scope-and-write` | `20f16d07ab4ea62e5cd3f27ef09a6d5b036d2392` | ja, nur in diesem Branch | BaseStats-/Types-Scope-and-Write-Fix fuer CFRU/DPE; basiert auf Learnset-GUI-Flow-Safety-Fix `086d2a91` |
...
| Gepinnter Workspace-Stand | `20f16d07ab4ea62e5cd3f27ef09a6d5b036d2392` auf `compat/upr-fvx-cfru-dpe-base-stats-types-scope-and-write`; enthaelt den CFRU/DPE-BaseStats-/Types-Scope-and-Write-Fix auf Basis des Learnset-GUI-Flow-Safety-Fix `086d2a91` |

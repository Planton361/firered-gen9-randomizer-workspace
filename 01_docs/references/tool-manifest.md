...
Dieser Stand dokumentiert den Arbeitsblock `compat/upr-fvx-cfru-dpe-trainer-held-items-lazy-movesets`. UPR-FVX wurde im Planton361-Fork-Submodule gezielt geaendert und gebaut; lokale ROM-/Log-/Output-Artefakte blieben ignored unter `05_builds/**` und wurden nicht committed. Tool-Binaries, Release-Assets, Secrets und private Pfade wurden nicht dokumentiert.
...
Der aktuelle Arbeitsblock pinnt den Workspace auf den UPR-FVX-Trainer-Held-Items-lazy-Moveset-Fix-Commit fuer CFRU/DPE.

| Tool/Repo | Zweck | Upstream | Fork/Origin | Lokaler Pfad | Branch | Commit | Codex darf ändern | Status |
|---|---|---|---|---|---|---|---|---|
| Workspace Repo | Source of Truth | n/a | git@github.com:Planton361/firered-gen9-randomizer-workspace.git | Workspace-Root | `compat/upr-fvx-cfru-dpe-trainer-held-items-lazy-movesets` | offen | ja, nur Branches | aktiv |
...
Arbeitsblock: `compat/upr-fvx-cfru-dpe-trainer-held-items-lazy-movesets`.

| Repo | Zweck | Origin | Lokaler Pfad | Branch | Commit | Codex darf aendern | Status |
|---|---|---|---|---|---|---|---|
| UPR-FVX Fork | Haupt-Randomizer-Fork | `https://github.com/Planton361/universal-pokemon-randomizer-fvx.git` | `02_external/upr-fvx` | `compat/upr-fvx-cfru-dpe-trainer-held-items-lazy-movesets` | `3864ad0e7efda4ed8a329fb22edb3a28db1040e8` | ja, nur in diesem Branch | Trainer-Held-Items-lazy-Moveset-Fix fuer CFRU/DPE; basiert auf `18766c49` |
...
| Arbeitsbranch | `compat/upr-fvx-cfru-dpe-trainer-held-items-lazy-movesets` |
| Gepinnter Workspace-Stand | `3864ad0e7efda4ed8a329fb22edb3a28db1040e8` auf `compat/upr-fvx-cfru-dpe-trainer-held-items-lazy-movesets`; enthaelt den CFRU/DPE-Trainer-Held-Items-lazy-Moveset-Fix auf Basis des Evolution-Fix `18766c49` |

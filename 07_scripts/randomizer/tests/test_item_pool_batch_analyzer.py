...
class ItemPoolBatchAnalyzerTest(unittest.TestCase):
    ...
    def test_suspicious_items_are_marked(self):
        ...
        self.assertTrue(analyzer.classify_item("CharzarditeX").suspicious)
        self.assertTrue(analyzer.classify_item("Charzardite Y").suspicious)
        self.assertTrue(analyzer.classify_item("Pikshunium Z").suspicious)
        self.assertTrue(analyzer.classify_item("Wish Piece").suspicious)
        self.assertTrue(analyzer.classify_item("Shiny Charm").suspicious)
        self.assertTrue(analyzer.classify_item("Magma Stone").suspicious)
        self.assertTrue(analyzer.classify_item("Red Flute").suspicious)
        ...
        self.assertFalse(analyzer.classify_item("Blk Augurite").suspicious)
        self.assertFalse(analyzer.classify_item("Absorb Bulb").suspicious)
        self.assertFalse(analyzer.classify_item("Adrenal Orb").suspicious)
        self.assertFalse(analyzer.classify_item("Flame Orb").suspicious)
        self.assertFalse(analyzer.classify_item("Toxic Orb").suspicious)
        self.assertFalse(analyzer.classify_item("Red Card").suspicious)
        self.assertFalse(analyzer.classify_item("Hard Stone").suspicious)

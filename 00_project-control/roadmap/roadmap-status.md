...
|---|---|---|
| 08 Randomizer-Kompatibilität | Trainer-Pokémon erweitern | Trainer-Species-only ist P1-supported; Trainer-Movesets, Held Items und weitere Trainer-Pfade bleiben separat |

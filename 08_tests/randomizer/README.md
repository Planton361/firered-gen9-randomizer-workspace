...
| 170 | `170_evolution_methods_scope_plan.md` | CFRU/DPE Evolution Methods Scope Plan | read-only Plan: `methods-plan-ready`; `FVX-TRAIT-024` bis `027` bleiben separate Methoden-/Improvement-Slices mit Method-Mapping-, ExtraInfo-, Level-, Time- und Writer-/Reload-Risiken | keiner, read-only Analyse | ja |
